...
$evm_dir/EvmUtils/partition_EVM_inputs.pl \
...
$evm_dir/EvmUtils/write_EVM_commands.pl \
    --genome ./../genome.uppercase.fa \
    --weights $EVM_weights  \
    --gene_predictions ./../$genome_tag.nuclear_genome.maker.combined.gff3 \
...
$evm_dir/EvmUtils/execute_EVM_commands.pl $genome_tag.nuclear_genome.commands.list | tee $genome_tag.nuclear_genome.EVM_run.log
$evm_dir/EvmUtils/recombine_EVM_partial_outputs.pl \
    --partitions $genome_tag.nuclear_genome.partitions_list.out \
    --output_file_name $genome_tag.nuclear_genome.evm.out
$evm_dir/EvmUtils/convert_EVM_outputs_to_GFF3.pl \
    --partitions $genome_tag.nuclear_genome.partitions_list.out \
