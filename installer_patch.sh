...
/usr/bin/time -v bash ${LRSDAY_HOME}/soft/install_marginpolish.sh ${MARGINPOLISH_VERSION} ${MARGINPOLISH_DOWNLOAD_URL} ${MARGINPOLISH_GITHUB_COMMIT_VERSION} ${SUSE} > ${LRSDAY_HOME}/soft/Log/install_marginpolish.log 2> ${LRSDAY_HOME}/soft/Err/install_marginpolish.err
...
if [ $CIRCLATOR == "yes" ] && [ "${SUSE}" == "no" ]
then

CIRCLATOR_VERSION="1.5.5"

/usr/bin/time -v bash ${LRSDAY_HOME}/soft/install_circlator.sh ${CIRCLATOR_VERSION} ${SUSE} > ${LRSDAY_HOME}/soft/Log/install_circlator.log 2> ${LRSDAY_HOME}/soft/Err/install_circlator.err
...
/usr/bin/time -v bash ${LRSDAY_HOME}/soft/install_susepacks.sh > ${LRSDAY_HOME}/soft/Log/install_susepacks.log 2> ${LRSDAY_HOME}/soft/Err/install_susepacks.err

fi

# ---- RAGOO SUSE ---- # OK

if [ $RAGOO == "yes" ] && [ "${SUSE}" == "yes" ]
then
...
echo ""
echo "7) If you run SUSE you have to check if maker instalation succeded. Running ./maker binaries it will be clear. If you get an error you will probaly need to proceed with the manual installation. Follow the instructions printed on the terminal to perform a local installation."
echo ""
echo "#########################################################"
